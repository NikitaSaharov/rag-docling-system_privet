...
7. В КОНЦЕ КАЖДОГО ОТВЕТА обязательно добавь строку: "Источник: [название файла]" — используй имя файла из меток [Источник: ...] в контексте. Если использовано несколько файлов — перечисли все через запятую
